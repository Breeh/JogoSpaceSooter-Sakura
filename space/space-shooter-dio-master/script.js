...
const aliensImg = ['img/cartaclowagua.png', 'img/cartaclowfogo.png', 'img/cartaclowgrama.png'];
...
function createLaserElement() {
    ...
    newLaser.src = 'img/magicPink.png';
